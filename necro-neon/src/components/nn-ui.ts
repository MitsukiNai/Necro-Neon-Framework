...
import type { ProgressOptions, SpinnerOptions, AvatarOptions, NNColor, NNSize } from '../types/index.js';
...
export class NNProgress {
  ...
  setValue(value: number): void {
    ...
    if (this.valueLabel) this.valueLabel.textContent = `${this._value}%`;
  }
...
const SIZE_MAP: Record<NNSize, string> = {
...
const AVATAR_SIZE_MAP: Record<NNSize, string> = {
...
const COLOR_MAP: Record<NNColor, string> = {
