...
git clone https://github.com/LauraRodal/necro-neon.git
...
<body data-district="tokyo-night">
  ...
  <!-- Scripts del framework al final del body -->
  <script src="necro-neon/dist/index.js"></script>
  <script src="necro-neon/necro-neon.js"></script>
</body>
```
...
走れ。逃げろ。生き残れ。# NECRO-NEON Framework v3.0
### 呪われたネオン都市 — Infestation Edition
